...
init_Hmin , init_Hmax = 0 , 255
init_Smin , init_Smax = 0 , 255
...
def main():
    ...
    while True:
        ...
        img = cv2.imread('/home/alexcarri/catkin_ws/src/actividades/Mod4/Amarillo/Semaforo_164.jpg')
        ...
        hsv_min1 = np.array([0 , 0 , 192])
        hsv_max1 = np.array([180 , 255 , 255])

        inverse = cv2.bitwise_not(hsv_img)

        mask = cv2.inRange(inverse , hsv_min , hsv_max)
